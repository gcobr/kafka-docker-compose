...
- For Kafka connection issues, verify the bootstrap servers configuration in your client applications</content>
<parameter name="filePath">/Users/gabriel/GitHub/gcobr/kafka-docker-compose/README.md